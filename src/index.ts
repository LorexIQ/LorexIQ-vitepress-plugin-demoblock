...
const pluginVitePressDemoBlock = (_opt?: UserOptions): PluginOption => {
...
export const PluginVitePressDemoBlock = pluginVitePressDemoBlock

export default pluginVitePressDemoBlock
